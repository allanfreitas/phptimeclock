...
if ($request == 'POST'){
    ...
    if ($show_display_name == "yes") {
        ...
        if (isset($displayname)) {
            ...
            if ((!isset($tmp_displayname)) && (!empty($displayname))) {echo "Nome de usuario nao esta no banco de dados.\n"; exit;}
    ...
    elseif ($show_display_name == "no") {
        ...
        if (isset($fullname)) {
            ...
            if ((!isset($tmp_empfullname)) && (!empty($fullname))) {echo "Nome de usuario nao esta no banco de dados.\n"; exit;}
...
echo "        <tr><td class=title_underline height=4 align=left valign=middle style='padding-left:10px;'>Faca o login abaixo:</td></tr>\n";
echo "        <tr><td height=7></td></tr>\n";
echo "        <tr><td height=4 align=left valign=middle class=misc_items>Nome:</td></tr>\n";
...
if ($use_passwd == "yes") {	
    echo "        <tr><td height=4 align=left valign=middle class=misc_items>Senha:</td></tr>\n";
    echo "        <tr><td height=4 align=left valign=middle class=misc_items>";
    echo          "<input type='password' name='employee_passwd' maxlength='25' size='17' tabindex=2></td></tr>\n";
    echo "        <tr><td height=7></td></tr>\n";
}

echo "        <tr><td height=4 align=left valign=middle class=misc_items>Entrada/Saida:</td></tr>\n";
echo "        <tr><td height=4 align=left valign=middle class=misc_items>\n";
...
echo "        <tr><td height=7></td></tr>\n";
echo "        <tr><td height=4 align=left valign=middle class=misc_items>Notas / Observacoes:</td></tr>\n";
echo "        <tr><td height=4 align=left valign=middle class=misc_items>";  
...
if (!isset($_COOKIE['remember_me'])) {
    echo "        <tr><td width=100%><table width=100% border=0 cellpadding=0 cellspacing=0>
                  <tr><td nowrap height=4 align=left valign=middle class=misc_items width=10%>Lembrar-me?</td><td width=90% align=left 
...
elseif (isset($_COOKIE['remember_me'])) {
    echo "        <tr><td width=100%><table width=100% border=0 cellpadding=0 cellspacing=0>
                  <tr><td nowrap height=4 align=left valign=middle class=misc_items width=10%>Esquecer-me?</td><td width=90% align=left 
                    class=misc_items style='padding-left:0px;padding-right:0px;' tabindex=5><input type='checkbox' name='reset_cookie' value='1'></td></tr>
                    </table></td><tr>\n";
}

echo "        <tr><td height=7></td></tr>\n";
echo "        <tr><td height=4 align=left valign=middle class=misc_items><input type='submit' name='submit_button' value='Enviar' align='center' 
...
if ($request == 'POST') {
    ...
    if (!isset($tmp_inout)) {echo "Status de Entrada/Saida nao esta no banco de dados.\n"; exit;}
    ...
    if ($show_display_name == "yes") {
        ...
        if (!$displayname && !$inout) {
            ...
            echo "          <td valign=top>\n";
            echo "<br />\n";
            echo "Voce nao escolheu um usuario ou status. Por favor tente novamente.\n";
            include 'footer.php';
            exit;
        }
        ...
        if (!$displayname) {
            ...
            echo "          <td valign=top>\n";
            echo "<br />\n";
            echo "Voce nao escolheu um usuario. Por favor tente novamente.\n";
            include 'footer.php';
            exit;
        }
    ...
    if (!$inout) {
        ...
        echo "          <td valign=top>\n";
        echo "<br />\n";
        echo "Voce nao escolheu um status. Por favor tente novamente.\n";
        include 'footer.php';
        exit;
    }
    ...
    if ($employee_passwd == $tmp_password) {
        ...
        echo "Voce digitou a senha errada para $strip_fullname. Por favor,tente novamente.";
