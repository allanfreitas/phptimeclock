...
echo "<title>$title - Log de auditoria</title>\n";
...
echo "              <tr><td class=table_rows width=20 align=center><img src='../images/icons/information.png' /></td><td class=table_rows
                      style='color:#3366CC;'>Este relatorio ira exibir todas as informacoes relativas a Punch-in/out vezes que foram
                      adicionado, editado ou excluido do PHP Timeclock.</td></tr>\n";
echo "            </table>\n";
echo "            <br />\n";
...
echo "              <tr>\n";
echo "                <th class=rightside_heading nowrap halign=left colspan=3><img src='../images/icons/report.png' />&nbsp;&nbsp;&nbsp;Log de auditoria</th>
                    </tr>\n";
...
echo "  <tr><td width=80% style='font-size:9px;color:#000000;padding-left:10px;'>Gerado em: $rpt_time, $rpt_date</td><td nowrap
                style='font-size:9px;color:#000000;'>Log de auditoria</td></tr>\n";
...
if (!empty($tmp_csv)) {
  echo "  <tr class=notprint><td width=80%></td><td nowrap style='font-size:9px;color:#000000;'><a style='color:#27408b;font-size:9px;
                  ...
                  href=\"get_csv.php?rpt=auditlog&&csv=$tmp_csv&from=$from_timestamp&to=$to_timestamp&tzo=$tzo\">Download arquivo CSV</a></td></tr>\n";
}
echo "</table>\n";
