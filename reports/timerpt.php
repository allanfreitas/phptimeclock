...
echo "<title>$title - Relatorio de horas diarias</title>\n";
...
echo "              <tr>\n";
echo "                <th class=rightside_heading nowrap halign=left colspan=3><img src='../images/icons/report.png' />&nbsp;&nbsp;&nbsp;Relatorio 
                    diario</th></tr>\n";
...
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Nome do usuario:</td><td colspan=2 align=left width=80%
...
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Escolha trabalho:</td><td colspan=2 width=80%
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;'>
                      <select name='office_name' onchange='group_names();'>\n";
echo "                      </select></td></tr>\n";
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Escolha grup:</td><td colspan=2 width=80%
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;'>
                      <select name='group_name' onchange='user_names();'>\n";
echo "                      </select></td></tr>\n";
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Escolha usuario:</td><td colspan=2 width=80%
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;'>
                      <select name='user_name'>\n";
echo "                      </select></td></tr>\n";
}
echo "              <tr><td class=table_rows style='padding-left:32px;' width=20% nowrap>Apartir de: ($tmp_datefmt)</td><td
                      ...
                      return false;\" name=\"from_date_anchor\" id=\"from_date_anchor\" style='font-size:11px;color:#27408b;'>Abrir calendario</a></td><tr>\n";
echo "              <tr><td class=table_rows style='padding-left:32px;' width=20% nowrap>Ate: ($tmp_datefmt)</td><td
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;' width=80% >
                      ...
                      return false;\" name=\"to_date_anchor\" id=\"to_date_anchor\" style='font-size:11px;color:#27408b;'>Abrir calendario</a></td><tr>\n";
...
echo "              <tr><td class=table_rows height=25 valign=bottom>1.&nbsp;&nbsp;&nbsp;Exportar em CSV? (link para o arquivo CSV estara no canto superior direito da pagina seguinte)</td></tr>\n";
...
echo "              <tr><td class=table_rows height=25 valign=bottom>2.&nbsp;&nbsp;&nbsp;Exibir informacoes sobre o endereco ip de conexao?
                      </td></tr>\n";
if ($display_ip == "yes") {
...
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Escolha trabalho:</td><td colspan=2 width=80%
                      ...
                      <select name='office_name' onchange='group_names();'>\n";
echo "                      </select></td></tr>\n";
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Escolha grupo:</td><td colspan=2 width=80%
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;'>
...
echo "              <tr><td class=table_rows style='padding-left:32px;' width=20% nowrap>Apartir da data: ($tmp_datefmt)</td><td
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;' width=80% >
...
echo "              <tr><td width=80% style='font-size:9px;color:#000000;padding-left:10px;'>Gerado em: $rpt_time, $rpt_date</td><td nowrap
