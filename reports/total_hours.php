...
echo "<title>$title - Relatorio de Horas Trabalhadas</title>\n";
...
echo "                <th class=rightside_heading nowrap halign=left colspan=3><img src='../images/icons/report.png' />&nbsp;&nbsp;&nbsp; 
                    Relatorio de Horas Trabalhadas</th></tr>\n";
...
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Mudar trabalho:</td><td colspan=2 width=80%
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;'>
                      <select name='office_name' onchange='group_names();'>\n";
echo "                      </select></td></tr>\n";
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Mudar grupo:</td><td colspan=2 width=80%
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;'>
                      <select name='group_name' onchange='user_names();'>\n";
echo "                      </select></td></tr>\n";
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Mudar usuario:</td><td colspan=2 width=80%
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;'>
                      <select name='user_name'>\n";
echo "                      </select></td></tr>\n";
}
echo "              <tr><td class=table_rows style='padding-left:32px;' width=20% nowrap>Apartir de: ($tmp_datefmt)</td><td
                      ...
                      return false;\" name=\"from_date_anchor\" id=\"from_date_anchor\" style='font-size:11px;color:#27408b;'>Exibir calendario</a></td><tr>\n";
echo "              <tr><td class=table_rows style='padding-left:32px;' width=20% nowrap>Ate a data: ($tmp_datefmt)</td><td
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;' width=80% >
                      ...
                      return false;\" name=\"to_date_anchor\" id=\"to_date_anchor\" style='font-size:11px;color:#27408b;'>Exibir calendario</a></td><tr>\n";
echo "              <tr><td class=table_rows align=right colspan=3 style='color:red;font-family:Tahoma;font-size:10px;'>*&nbsp;requerido&nbsp;</td></tr>\n";
echo "            </table>\n";
...
echo "              <tr><td class=table_rows height=25 valign=bottom>1.&nbsp;&nbsp;&nbsp;Exportar para CSV? (Link para o arquivo CSV estara no canto superior direito
                      proxima pagina)</td></tr>\n";
if (strtolower($export_csv) == "yes") {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='csv' value='1' checked>&nbsp;Sim
                      <input type='radio' name='csv' value='0'>&nbsp;Nao</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='csv' value='1'>&nbsp;Sim
                      <input type='radio' name='csv' value='0' checked>&nbsp;Nao</td></tr>\n";
}
echo "              <tr><td class=table_rows height=25 valign=bottom>2.&nbsp;&nbsp;&nbsp;Paginar este relatorio assim que o tempo de cada usuario e impresso
                      em uma pagina separada?</td></tr>\n";
if ($paginate == "yes") {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_paginate' value='1' checked>&nbsp;Sim
                      <input type='radio' name='tmp_paginate' value='0'>&nbsp;Nao</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_paginate' value='1'>&nbsp;Sim
                      <input type='radio' name='tmp_paginate' value='0' checked>&nbsp;Nao</td></tr>\n";
}
echo "              <tr><td class=table_rows height=25 valign=bottom>3.&nbsp;&nbsp;&nbsp;Mostrar detalhes?</td></tr>\n";
...
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_show_details' value='1' 
                      checked onFocus=\"javascript:form.tmp_display_ip[0].disabled=false;form.tmp_display_ip[1].disabled=false;\">&nbsp;Sim&nbsp;<input 
                      type='radio' name='tmp_show_details' value='0' onFocus=\"javascript:form.tmp_display_ip[0].disabled=true;
                      form.tmp_display_ip[1].disabled=true;\">&nbsp;Nao</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_show_details' value='1' 
                      onFocus=\"javascript:form.tmp_display_ip[0].disabled=false;form.tmp_display_ip[1].disabled=false;\">&nbsp;Sim&nbsp;<input 
...
if ($show_details == 'yes') {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_show_details' value='1' 
                      checked>&nbsp;Yes&nbsp;<input type='radio' name='tmp_show_details' value='0'>&nbsp;Nao</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_show_details' value='1' 
                      >&nbsp;Yes&nbsp;<input type='radio' name='tmp_show_details' value='0' checked>&nbsp;Nao</td></tr>\n";
}
}
if (strtolower($ip_logging) == "yes") {
echo "              <tr><td class=table_rows height=25 valign=bottom>4.&nbsp;&nbsp;&nbsp;Exibir informacees sobre o endereco ip de conexao?
                      (Apenas disponivel se \"Mostrar detalhes?\" E definido como \"sim\".)</td></tr>\n";
if ($show_details == 'yes') {
if ($display_ip == "yes") {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_display_ip' value='1' 
                      checked>&nbsp;Sim&nbsp;<input type='radio' name='tmp_display_ip' value='0'>&nbsp;Nao</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_display_ip' value='1' >&nbsp;Sim
                      <input type='radio' name='tmp_display_ip' value='0' checked>&nbsp;Nao</td></tr>\n";
}
} else {
if ($display_ip == "yes") {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_display_ip' value='1' 
                      checked disabled>&nbsp;Sim&nbsp;<input type='radio' name='tmp_display_ip' value='0' disabled>&nbsp;Nao</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_display_ip' value='1' 
                      disabled>&nbsp;Sim&nbsp;<input type='radio' name='tmp_display_ip' value='0' checked disabled>&nbsp;Nao</td></tr>\n";
}
}
} 
if (strtolower($ip_logging) == "yes") {
echo "              <tr><td colspan=2 class=table_rows height=25 valign=bottom>5.&nbsp;&nbsp;&nbsp;Rodada de tempo de cada usuario?</td></tr>\n";
} else { 
echo "              <tr><td colspan=2 class=table_rows height=25 valign=bottom>4.&nbsp;&nbsp;&nbsp;Rodada de tempo de cada usuario?</td></tr>\n";
}
if ($round_time == '1') {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='1'
                      checked>&nbsp;A aproximacao de 5 minutos (1/12th de uma hora)</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='1'>&nbsp;Para o
                      mais proximo de 5 minutos (1/12th de uma hora)</td></tr>\n";
}
if ($round_time == '2') {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='2'
                      checked>&nbsp;A aproximacao de 10 minutos (1/6th de uma hora)</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='2'>&nbsp;Para
                      aproximacao de 10 minutos (1/6th de uma hora)</td></tr>\n";
}
if ($round_time == '3') {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='3'
                      checked>&nbsp;A aproximacao de 15 minutos (1/4th de uma hora)</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='3'>&nbsp;Para
                      mais proximo dos 15 minutos (1/4th de uma hora)</td></tr>\n";
}
if ($round_time == '4') {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='4'
                      checked>&nbsp;A aproximacao de 20 minutos (1/3rd de uma hora)</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='4'>&nbsp;Para
                      aproximacao de 20 minutos (1/3rd de uma hora)</td></tr>\n";
}
if ($round_time == '5') {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='5'
                      checked>&nbsp;A aproximacao de 30 minutos (02/01 de hora)</td></tr>\n";
} else {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value='5'>&nbsp;Para
                      aproximacao de 30 minutos (02/01 de hora)</td></tr>\n";
}
if (empty($round_time)) {
echo "              <tr><td class=table_rows align=left nowrap style='padding-left:15px;'><input type='radio' name='tmp_round_time' value=0 checked>&nbsp;Nao
					fazer volta</td></tr>\n";
} else {
...
echo "  <tr><td width=80% style='font-size:9px;color:#000000;'>Executado em: $rpt_time, $rpt_date</td><td nowrap style='font-size:9px;color:#000000;'>
          $rpt_name</td></tr>\n";
echo "  <tr><td width=80%></td><td nowrap style='font-size:9px;color:#000000;'>Intervalo de datas: $from_date - $to_date</td></tr>\n";
if (!empty($tmp_csv)) {
...
for ($x=0;$x<$employees_cnt;$x++) {
    ...
    echo "  <tr><td width=75% nowrap align=left style='color:#27408b;'><b><u>Data</u></b></td>\n";
    echo "      <td width=25% nowrap align=left style='color:#27408b;'><b><u>Horas trabalhadas</u></b></td></tr>\n";
...
//                      }
    ...
    if (isset($currently_punched_in)) {
        ...
        echo "              <tr align=\"left\"><td width=12% nowrap style='font-size:11px;color:#000000;border-style:solid;border-color:#888888;
                              ...
                              border-width:1px 0px 0px 0px;'><b>$employees_empfullname[$x] esta trabalhando.</b></td>\n";
